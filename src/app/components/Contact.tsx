...
const contactInfo = [
  { icon: Mail, label: 'EMAIL', value: 'arfinrabbi@gmail.com', link: 'mailto:arfinrabbi@gmail.com' },
  { icon: Phone, label: 'PHONE', value: '+8801973119795', link: 'tel:+8801973119795' },
    ...
    <section id="contact" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact cards - full width with increased card width */}
          <motion.div
          ...
          >
            {contactInfo.map((info, index) => {
              ...
              const cardContent = (
                <BracketCard hover={false} className="flex items-center gap-6 w-full">
                  <div className="w-14 h-14 border border-[#00C8FF] flex items-center justify-center bg-[#00C8FF]/5 flex-shrink-0">
                    <Icon className="w-6 h-6 text-[#00C8FF]" strokeWidth={1.5} />
                  </div>
                  <div>
                    <div className="font-['IBM_Plex_Mono'] text-[#4A6B88] text-xs uppercase tracking-wider mb-1">
                      {info.label}
                    </div>
                    <div className="font-['IBM_Plex_Mono'] text-[#E8F4FF] text-base md:text-lg">
                      {'link' in info ? (
                        <a 
                          href={info.link} 
